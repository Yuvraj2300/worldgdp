package com.ys.worldgdp.test.controller.api;
...
import com.ys.worldgdp.config.AppConfiguration;
...
public class CityAPIControllerTest {
	...
	public void testDeleteCity() throws Exception {
		...
		this.mockMvc.perform(delete("/api/cities/{cityId}", cityId)).andDo(MockMvcResultHandlers.print())
